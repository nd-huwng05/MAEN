...
def train(config,args, name):
    ...
    for epoch in range(start, args.epochs):
        train_stats = train_one_epoch(models, dataloader_train, optimizers, loss_scalers, args, epoch,loss, log_writer)
        ...
        test_stats = test_one_epoch(models, dataloader_test, args, epoch,name,log_writer)
